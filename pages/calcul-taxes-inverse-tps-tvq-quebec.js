  ...
  return (
    <div className="page-container">
      <Head>
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_WEBSITE_URL}/calcul-taxes-inverse-tps-tvq-quebec.html`}
        />
        <title>Calcul taxes inverse 2021 Québec et Canada sans publicité | Finance D</title>
      </Head>
      <TaxCalculator
