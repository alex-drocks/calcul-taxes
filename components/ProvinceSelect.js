  ...
  return (
    <div className="field">
      ...
      >
        ...
        <option
          value="Colombie-Britanique (TPS 5%)"
          data-tps={0.05}
          data-tvp={0}>
          Colombie-Britanique (TPS 5%)
        </option>
        <option
          value="Colombie-Britanique (TPS 5% + TVP 7%)"
          data-tps={0.05}
          data-tvp={0.07}>
          Colombie-Britanique (TPS 5% + TVP 7%)
        </option>
        <option
          value="Île-du-Prince-Édouard (TVH 15%)"
          data-tps={0.15}
          data-tvp={0}>
          Île-du-Prince-Édouard (TVH 15%)
        </option>
        <option
          value="Manitoba (TPS 5%)"
          data-tps={0.05}
          data-tvp={0}>
          Manitoba (TPS 5%)
        </option>
        <option
          value="Manitoba (TPS 5% + TVP 8%)"
          data-tps={0.05}
          data-tvp={0.08}>
          Manitoba (TPS 5% + TVP 8%)
        </option>
        <option
          value="Nouveau-Brunswick (TVH 15%)"
          data-tps={0.15}
          data-tvp={0}>
          Nouveau-Brunswick (TVH 15%)
        </option>
        <option
          value="Nouvelle-Écosse (TVH 15%)"
          data-tps={0.15}
          data-tvp={0}>
        ...
        <option
          value="Saskatchewan (TPS 5%)"
          data-tps={0.05}
          data-tvp={0}>
          Saskatchewan (TPS 5%)
        </option>
        <option
          value="Saskatchewan (TPS 5% + TVP 6%)"
          data-tps={0.05}
          data-tvp={0.06}>
          Saskatchewan (TPS 5% + TVP 6%)
        </option>
        <option
          value="Terre-Neuve-et-Labrador (TVH 15%)"
          data-tps={0.15}
          data-tvp={0}>
          Terre-Neuve-et-Labrador (TVH 15%)
        </option>
        <option
          value="Territoires du Nord-Ouest (TPS 5%)"
          data-tps={0.05}
          data-tvp={0}>
